...
- **Software:** CST Microwave Studio, Ansys HFSS, DesignPro, LTSpice, Altium Designer, Blender, Solidworks 
- **Laboratory Instruments:** Signal Spectrum Analyzer, Vector Network Analyzer, PCB Engraving Machine, Robotic Arms
...
- [Smart Garbage IoT for Sustainable Cities Using Blynk](https://github.com/alasulu/Comp413_g8_SmartGarbageSystem): An ESP32-WROVER based IoT system integrating multiple sensors for real-time waste monitoring, featuring a web interface and Blynk cloud connectivity.
...
Feel free to explore my repositories and reach out if you’d like to ask any questions!
